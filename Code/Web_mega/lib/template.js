module.exports = {
    ...
    megaMovieChart : function(listMovieInfo) {
        function createMovieChartHTML(title, rated, 시청연령, imgName, rank) {
                return `
                <div class="swiper-slide">
                    <div class="poster">
                        <figure>
                            <img src="assets/img/${imgName}.jpg" srcset="assets/img/${imgName}@2.jpg 2x" alt="${title}">
                        </figure>
                        <div class="rank"><strong>${rank}</strong></div>
                        <div class="mx">
                            <span class="icon m ir_pm">MX</span>
                            <span class="icon b ir_pm">Boutique</span>   // how to make this i/o without conditional statement
                        </div>
                    </div>
                    <div class="infor">
                        <h3><span class="icon ${시청연령} ir_pm">${rated}</span> <strong>${title}</strong></h3>
                        <div class="infor_btn">
                            <a href="#">상세정보</a>
                            <a href="#">예매하기</a>
                        </div>
        ...
        var result = ``;
            listMovieInfo.forEach(function(list){
            result += `${createMovieChartHTML(list.title, list.rated, list.시청연령, list.imgName, list.rank)}`
        });
        return result;
    },
